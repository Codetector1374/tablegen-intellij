...
public class TableGenDagArgImpl extends ASTWrapperPsiElement implements TableGenDagArg {

  public TableGenDagArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TableGenVisitor visitor) {
    visitor.visitDagArg(this);
  }
  ...
  public PsiElement getVarname() {
    return findChildByType(VARNAME);
  }
