...
public class TableGenValueImpl extends ASTWrapperPsiElement implements TableGenValue {

  public TableGenValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public TableGenSimpleValue getSimpleValue() {
    return findNotNullChildByClass(TableGenSimpleValue.class);
  }
