...
public class TableGenBodyImpl extends ASTWrapperPsiElement implements TableGenBody {

  public TableGenBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public TableGenBodyList getBodyList() {
    return findChildByClass(TableGenBodyList.class);
  }
