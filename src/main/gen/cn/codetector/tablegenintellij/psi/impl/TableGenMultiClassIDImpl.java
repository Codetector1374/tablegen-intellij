...
public class TableGenMultiClassIDImpl extends ASTWrapperPsiElement implements TableGenMultiClassID {

  public TableGenMultiClassIDImpl(@NotNull ASTNode node) {
    super(node);
  }
