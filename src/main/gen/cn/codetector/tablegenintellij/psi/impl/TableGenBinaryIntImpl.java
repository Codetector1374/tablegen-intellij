...
public class TableGenBinaryIntImpl extends ASTWrapperPsiElement implements TableGenBinaryInt {

  public TableGenBinaryIntImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TableGenVisitor visitor) {
    visitor.visitBinaryInt(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getBinInt() {
    return findNotNullChildByType(BIN_INT);
  }
