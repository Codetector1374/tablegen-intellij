...
public class TableGenDecimalIntegerImpl extends ASTWrapperPsiElement implements TableGenDecimalInteger {

  public TableGenDecimalIntegerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TableGenVisitor visitor) {
    visitor.visitDecimalInteger(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getDecInt() {
    return findNotNullChildByType(DEC_INT);
  }
